...
let getPath = (maze, path = [], illegalSpaces = new Map()) => {
...
let getPathHelper = (maze, row, col, path, illegalSpaces) => {
	...
	let atEnd = row == maze.length - 1 && col == maze[0].length - 1;
...
console.log(getPath(possibleMaze));
console.log(getPath(impossibleMaze));
