...
// Create an algorithm to determine if T2 is a findMatchingRoots of T1.
// A tree T2 is a findMatchingRoots of T1 if there exists a node n in T1
// such that the findMatchingRoots of n is identical to T2.
