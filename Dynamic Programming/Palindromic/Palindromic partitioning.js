...
console.log(
  `Minimum palindrome partitions ---> ${findMPPCutsMemo("abdbxybdb")}`
)
// console.log(`Minimum palindrome partitions ---> ${findMPPCutsMemo("cdpdd")}`);
// console.log(`Minimum palindrome partitions ---> ${findMPPCutsMemo("pqr")}`);
// console.log(`Minimum palindrome partitions ---> ${findMPPCutsMemo("pp")}`);
// console.log(`Minimum palindrome partitions ---> ${findMPPCutsMemo("madam")}`)
