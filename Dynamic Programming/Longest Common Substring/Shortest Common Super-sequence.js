...
const SCSS = function (string1, string2) {
	function SCSSRecursive(str1, str2, i1, i2) {
		...
		let c1 = 1 + SCSSRecursive(str1, str2, i1 + 1, i2);
		let c2 = 1 + SCSSRecursive(str1, str2, i1, i2 + 1);
...
console.log(
	`Length of Shortest Common Subsequence: Substring: ---> ${SCSSDp(
		"dynamic",
		"programming"
	)}`
);
