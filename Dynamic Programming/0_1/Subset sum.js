...
// This is exactly the same as the Equal Subset Sum problem, but instead of the target sum being hallf the total sum, it's the full total sum.

let canPartition = function (nums, sum) {
	let n = nums.length;
	if (n == 0) return 0;
