...
const { Graph } = require("../Implementations/Data Structures/Graph.tsx")
...
const noCycleGraph = new DiGraph(noCycle)
const cycleGraph = new DiGraph(containsCycle)

console.log(noCycleGraph.detectCycle())
console.log(cycleGraph.detectCycle())
